...
public class SizeSelectioForVariation {
	...
	public void sizeSelection(WebDriver driver) throws InterruptedException {
		    ...
		    JavascriptExecutor js = (JavascriptExecutor)driver;
    	       ...
    	       }else if(memorySize.size()>0){
    	    	   System.out.println("memory size");
    	       }
    	       else {
    	    	   System.out.println("The product is not having a size element we are excuting only the size elements");
    	       }
