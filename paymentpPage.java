...
//		    	js.executeScript("arguments[0].click();", revieworder);
		    ...
		    //clickonrevieworderjs
		    @FindBy(xpath ="//button[@class = 'btn btn-primary btn-block submit-payment' and @name ='submit']")
			WebElement revieworderjs;
		    public void clickonrevieworderjs(WebDriver driver) throws InterruptedException {	
		    	
		    	((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", revieworder);

		    	JavascriptExecutor js = (JavascriptExecutor) driver;
		    	js.executeScript("arguments[0].click();", revieworderjs);
		    	//revieworder.click();
...
//		    	js.executeScript("arguments[0].click();", revieworder);
		    ...
		    WebElement salesforcePaypalCheckout=parentDiv.findElement(By.xpath("//div[contains(@class,'paypal-buttons-context-iframe paypal-buttons-label-paypal')]"));

		    salesforcePaypalCheckout.click();
		    ...
		    */
		    ...
		    @FindBy(xpath ="//input[@class ='sfpp-payment-method-radio sfpp-payment-method-radio-card']")
...
//		        driver.switchTo().defaultContent();
		  ...
		  //stripe  paymnet
            ...
            public void postalCode(WebDriver driver) {
                newCardNumber.sendKeys("765439877");
                driver.switchTo().defaultContent();
            }
            
            @FindBy(xpath ="(//input[@id ='saved-payment-security-code'])[1]")
		    WebElement existsSceuritycode;
		    public void existsSceuritycode(WebDriver driver) throws InterruptedException {	  
		    	
//		    	JavascriptExecutor js = (JavascriptExecutor) driver;
//		    	js.executeScript("arguments[0].click();", revieworder);
		    	
		    	existsSceuritycode.sendKeys("789");
